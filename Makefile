...
SOURCES_CPP= main.cpp BigInteger.cpp CorrectnessTest.cpp PerformanceLap.cpp PerformanceTest.cpp cpp/*.cpp c/*.cpp c_array/*.cpp c_base/*.cpp c_apint/*.cpp c_apint_radix/*.cpp	
SOURCES_C= big_integer.cpp big_integer_base.cpp big_integer_array.cpp big_integer_apint.cpp big_integer_apint_radix.cpp

#OBJECTS_CPP = $(SOURCES:.cpp=.o)
#OBJECTS_C = $(SOURCES:.cpp=.o)
